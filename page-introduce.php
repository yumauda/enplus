          ...
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">原材料研究・製品設計・生産工程研究に関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">製品設計・金型設計・金型加工技術に関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">特許や商標登録等、知的財産権の確保に関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">最新測定機器・評価装置による評価技術の確立に関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">品質保証・認証管理・社内規格・標準化に関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">外部・顧客環境に適応した最適生産に関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">最新鋭加工機による高精度金型の組上げに関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">成形生産の自動化・自動組立ライン設計他に関わる業務</p>
              </div>
            </div>
          </li>
        </ul>
        ...
        <ul class="p-science__cards p-lists">
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">当顧客業務改善の提案・当社製品の拡販等に関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">原材料副資材等の購買・品質管理等に関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">市場調査やプロモーションに関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">経理処理・決算・連結・税務・監査等、会社や組織内での「お金」に関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">人事制度設計・研修・社会保険等、会社や組織内での「人」に関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">企業全体の働く環境を整え、サポートする業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">経営戦略を企画し、会社経営のかじ取りをする業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
            ...
            <div class="p-lists__detail">
              ...
              <div class="p-lists__description">
                <p class="p-lists__text">法遵守・係争対応・契約対応等、会社や組織が遵守すべき「法律」に関わる業務</p>
              </div>
            </div>
          </li>
          <li class="p-lists__card">
